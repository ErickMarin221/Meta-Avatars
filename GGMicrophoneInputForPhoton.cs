...
using Photon.Voice;
  ...
  { 
    ...
    { 
        ...
        int micPos = GGMicrophone.Instance.GetPosition(); // loop detection 
        ...
        if (clip.channels == 0) 
        { 
            Error = "Number of channels is 0 in Read()"; //logger.LogError("[PV] MicWrapper: " + Error); 
            return false; 
        } 
        ...
        if (nextReadPos < micAbsPos) 
        {
            ...
            this.readAbsPos = nextReadPos; return true; 
